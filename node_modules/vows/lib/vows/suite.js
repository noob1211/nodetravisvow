...
this.Suite.prototype = new(function () {
    ...
    this.parseBatch = function (batch, matcher) {
        ...
        // so we know when the test are over.
    ...
    this.runBatch = function (batch) {
        ...
        (function run(ctx, lastTopic) {
            ...
            // Now run the test, or sub-contexts
            ...
            // Check if we're done running the test
...
//
// Checks if all the test in the batch have been run,
